...
parser.add_argument('--data', metavar='DIR',default='/media/cse101/08825CAD825CA14C/nadim/dataset/Autism_dataset',
...
parser.add_argument('--model', '-m', metavar='NAME', default='sequencer2d_l',
...
parser.add_argument('--checkpoint', default='/media/cse101/08825CAD825CA14C/nadim/checkpoint/20230321-190459-sequencer2d_l-224/model_best.pth.tar', type=str, metavar='PATH',
    ...
    for distortion_name, distortion_alex_value in distortions.items():
        ...
        for severity in range(1, 6):
            ...
            dataset = create_dataset(
                ...
                root=os.path.join(args.data), name=args.dataset, split=args.split,
