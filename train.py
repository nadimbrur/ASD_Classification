...
# Dataset parameters
parser.add_argument('--data_dir',default='/media/zasim/69366298-8e7c-477a-a176-aba06b9848d9/nadim/Facial Autism',
...
# Model parameters
parser.add_argument('--model', default='sequencer2d_l', type=str, metavar='MODEL',
...
parser.add_argument('--output', default='/media/zasim/69366298-8e7c-477a-a176-aba06b9848d9/nadim/sequencer-main/checkpoint', type=str, metavar='PATH',
...
#parser.parse_args(args)
    ...
    if args.start_epoch is not None:
        # a specified start_epoch will always override the resume epoch0
    ...
    #print(args.num_classes,args.train_split,args.dataset_download)
